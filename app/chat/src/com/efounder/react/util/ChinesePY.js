 ...
 */
var Pinyin = function() {}
var PinyinPrototype = Pinyin.prototype

PinyinPrototype._JMcode = {
	"-": "",
	"—": "",
	"\"": "",
	"#": "",
...
//单词首字母获取
PinyinPrototype.getWordsCode = function(str) {
	str = str.toUpperCase();
...
PinyinPrototype._ucfirst = function(l1) {
	if (l1.length > 0) {
...
PinyinPrototype._arraySearch = function(l1, l2) {
 ...
 * 获取汉字的简码拼音
 */
PinyinPrototype.GetJP = function(str) {
	str = str.toUpperCase();
	var len = str.length;
	var c, result = "",
		t;
...
PinyinPrototype.GetQP = function(l1) {
	var l2 = l1.length;
	var I1 = "";
 ...
 */
PinyinPrototype.GetHP = function(str) {
	var result = "";
