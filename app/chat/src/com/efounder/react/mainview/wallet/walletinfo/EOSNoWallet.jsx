...
//最好类名跟文件名对应
class EOSNoWallet extends React.Component {
  constructor(props) {
    super(props);
  }
  //组件挂载完成后回调
            ...
            <div style={{width:"100%"}}>
              <Row style={{width:"100%"}}>
                <Col span={24} style={{textAlign:"center"}}>
                  <img src={require('../../../resources/ewallet/eos.png')} style={{borderRadius:1000,height:this.props.windowHeight*0.12}}/>
                </Col>
              </Row>
              <Row style={{width:"100%",}}>
              ...
              <Row style={{width:"100%"}}>
                <Col span={24} style={{textAlign:"center"}}>
                  <button onClick={this.recoverWallet.bind(this)} style={{width:this.props.windowWidth*0.6,height:this.props.windowHeight*0.1,borderRadius:this.props.windowHeight*0.06,backgroundColor:"#F8931F",color:"#FFFFFF",border:"none",outline:"none",cursor: "pointer",}}>
                    恢复钱包
                  </button>
                </Col>
              </Row>
